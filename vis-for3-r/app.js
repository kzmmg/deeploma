			...
			window.fetch(pdb_id2)
				...
				.then((pdb2) => {
					...
					visualizer_both(container, pdb1, pdb2, {
						...
						reg_plane: Boolean(reg_plane_check.checked),
...
// show reg_plane checkbox
const reg_plane_check = window.document.createElement('input')

reg_plane_check.type = 'checkbox'
reg_plane_check.title = "show regression planes"
reg_plane_check.checked = true

check_group.append(reg_plane_check)

// show draw axis checkbox
const axis_check = window.document.createElement('input')

axis_check.type = 'checkbox'
axis_check.title = "show axis"
axis_check.checked = true

check_group.append(axis_check)
...
// create regression plane color slider
const reg_color_slider = window.document.createElement('input')

reg_color_slider.type = 'range'
reg_color_slider.value = 50
reg_color_slider.title = "regression plane color"
reg_color_slider.min = 0
reg_color_slider.max = 100

slider_group.append(reg_color_slider)

// create axis length slider
const axis_length_slider = window.document.createElement('input')

axis_length_slider.type = 'range'
axis_length_slider.value = 5
axis_length_slider.title = "axis length color"
axis_length_slider.min = 0
axis_length_slider.max = 100

slider_group.append(axis_length_slider)
...
reg_plane_check.addEventListener('change', 		do_fetch)
axis_check.addEventListener('change', 			do_fetch)
...
reg_color_slider.addEventListener('change', 	do_fetch)
axis_length_slider.addEventListener('change', 	do_fetch)
