...
function fill_scene(first_protein, second_protein, options) {
	...
	let mp1 = vis_helpers.compute_midpoint(bb1)
	
	geometry2.computeBoundingBox()
	let bb2 = geometry2.boundingBox
	let mp2 = vis_helpers.compute_midpoint(bb2)

	if (options.reg_plane) {
		let normal1 = vis_helpers.compute_normal(geometry1.vertices)
		let plane1 = vis_helpers.make_plane(normal1, bb1, options, mp1)
		
		//console.log(normal1, 'normal1')
		
		scene.add(plane1)
		
		let normal2 = vis_helpers.compute_normal(geometry2.vertices)
		let plane2 = vis_helpers.make_plane(normal2, bb2, options, mp2)
